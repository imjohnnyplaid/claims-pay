  ...
  return (
    <PortalLayout navConfig={navConfig} portalName="Internal Portal">
      <div className="p-6 md:p-8">
        <div className="mb-8">
          <h1 className="text-3xl font-semibold">Coding</h1>
          <p className="mt-1 text-muted-foreground">AI coding and claim processing</p>
        </div>

        <div className="flex items-center justify-center h-96">
          <p className="text-muted-foreground">Coding page content coming soon...</p>
        </div>
      </div>
    </PortalLayout>
  );
